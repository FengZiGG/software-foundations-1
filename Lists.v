...
Theorem rev_snoc : forall n l, rev (snoc l n) = n :: rev l.
Proof.
  intros. induction l.
  Case "[]". reflexivity.
  Case "h :: t". simpl. rewrite IHl. reflexivity.
...
Proof.
  ...
  Case "x :: xs".
    ...
    SCase "y :: ys".
      ...
      SSCase "0".
        destruct y as [| y'].
        SSSCase "0". simpl. rewrite IHxs. reflexivity.
        SSSCase "S y'". simpl. rewrite IHxs. reflexivity.
      SSCase "S x'".
        destruct y as [| y'].
        SSSCase "0". simpl. rewrite IHxs. reflexivity.
        SSSCase "S y'". simpl. rewrite IHxs. reflexivity.
...
Proof.
  ...
  Case "h :: t".
  induction n.
    SCase "0". rewrite ble_n_Sn. reflexivity.
